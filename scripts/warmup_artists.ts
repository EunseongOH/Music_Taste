...
const INDIE_RND_HIPHOP_ARTISTS = [
  ...
  "Ph-1 (피에이치원)", "Silica Gel (실리카겔)", "The Volunteers (더 볼런티어스)", "Se So Neon (새소년)", "Thornapple (쏜애플)",
  "Nerd Connection (너드커넥션)", "Wave to Earth (웨이브투에스)", "SURL (설)", "Standing Egg (스탠딩 에그)", "Cheeze (치즈)",
  "Stella Jang (스텔라장)", "Sunwoojunga (선우정아)", "Kwon Jin Ah (권진아)", "Sam Kim (샘김)", "Lee Jin Ah (이진아)",
  "Dept (뎁트)", "Skinny Brown (스키니브라운)", "George (죠지)", "THAMA (따마)", "Dvwn (다운)",
  "Lacuna (라쿠나)", "Kachisan (까치산)", "Kim Seung-ju (김승주)", "92914", "OOHYO (우효)",
  "Glen Check (글렌체크)", "Idiotape (이디앗테이프)", "Peppertones (페퍼톤스)", "Daybreak (데이브레이크)", "Soran (소란)",
  "Romantic Punch (로맨틱펀치)", "No Brain (노브레인)", "Crying Nut (크라잉넛)", "Dickpunks (딕펑스)", "Broccoli, you too? (브로콜리너마저)",
  "Autumn Vacation (가을방학)", "Epitone Project (에피톤 프로젝트)", "Sentimental Scenery (센티멘탈 시너리)", "Lucia (심규선)", "Taru (타루)",
  "Yozoh (요조)", "Han Hee Jung (한희정)", "J Rabbit (제이래빗)", "OKDAL (옥상달빛)", "Sweden Laundry (스웨덴세탁소)",
  "Vanilla Acoustic (바닐라 어쿠스틱)", "Acoustic Collabo (어쿠스틱 콜라보)", "Sugarbowl (슈가볼)", "Soulman (소울맨)", "Junggigo (정기고)",
  "Mad Clown (매드클라운)", "San E (산이)", "Verbal Jint (버벌진트)", "Swings (스윙스)", "Black Nut (블랙넛)",
  "Vasco (바스코 / 빌스택스)", "Justhis (저스디스)", "Kid Milli (키드밀리)", "NO:EL (노엘)", "Yanghongwon (양홍원)"
];
