 ...
 * ?theme= 가 오면 localStorage 에 저장하고, 없으면 저장된 값을 쓴다. 값이 없으면 아무것도 붙이지 않는다 = 기본(sky-tint). legacy 는 ?theme=legacy.
...
try {
  ...
  if (v && ok.includes(v)) document.documentElement.setAttribute('data-theme', v);
} catch {}
