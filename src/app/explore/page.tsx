...
export default function ExplorePage() {
  ...
  const t = {
    ko: {
      ...
      desc: isSingleArtistMode ? "아티스트 한 명을 골라 주세요. 그 아티스트의 곡을 모아서 소트해볼 수 있어요." : "최소 3명의 아티스트를 선택해 주세요.",
      genreLabel: "선택 장르:",
    ...
    en: {
      ...
      desc: isSingleArtistMode ? "Pick one artist. You can sort through their catalog." : "Please select at least 3 artists.",
